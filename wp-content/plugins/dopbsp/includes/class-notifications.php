...
* File Version            : 1.0.4
* Created / Last Modified : 06 October 2014
* Author                  : Dot on Paper
    ...
    if (!class_exists('DOPBSPNotifications')){
        class DOPBSPNotifications{
            ...
            */
             ...
             * @param smtp_ssl (string): SMTP use secure authentication
             ...
             * @param smtp_ssl2 (string): second SMTP use secure authentication
            ...
            function sendSMTP($email_to,
                ...
                $php_mailer->SMTPSecure = $smtp_ssl == 'true' ? ($smtp_host_port == '587' ? 'tls':'ssl'):'';
