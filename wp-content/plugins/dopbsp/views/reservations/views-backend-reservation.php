...
?>
                            <div class="dopbsp-buttons-wrapper">
                                ...
                                <a href="javascript:DOPBSP.confirmation('RESERVATIONS_RESERVATION_CANCEL_CONFIRMATION', 'DOPBSPReservation.cancel(<?php echo $reservation->id; ?>)')" class="dopbsp-button-cancel" style="display: <?php echo $display_cancel_button ? 'block':'none'; ?>"><?php echo $DOPBSP->text('RESERVATIONS_RESERVATION_CANCEL'); ?></a>
