...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndReservations')){
        class DOPBSPViewsBackEndReservations extends DOPBSPViewsBackEnd{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndReservations(){
            }
...
?>                        
                                ...
                                <div id="DOPBSP-inputs-reservations-filters-calendars" class="dopbsp-inputs-wrapper">
                                    ...
                                    <div class="dopbsp-input-wrapper dopbsp-last">
                                        <label>&nbsp;</label>
                                        <a href="javascript:DOPBSPReservationsList.display()" class="dopbsp-button dopbsp-reservations-list-button">
                                            <span class="dopbsp-info"><?php echo $DOPBSP->text('RESERVATIONS_FILTERS_VIEW_LIST'); ?></span>
                                        </a>
                                        <a href="javascript:DOPBSPReservationsCalendar.display()" class="dopbsp-button dopbsp-reservations-calendar-button">
                                            <span class="dopbsp-info"><?php echo $DOPBSP->text('RESERVATIONS_FILTERS_VIEW_CALENDAR'); ?></span>
                                        </a>
                                        <a href="javascript:DOPBSPReservationsAdd.display()" class="dopbsp-button dopbsp-reservations-add-button">
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('reservations-filters-period')" id="DOPBSP-inputs-button-reservations-filters-period" class="dopbsp-button"></a>
                                </div>
...
?>                
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('reservations-filters-status')" id="DOPBSP-inputs-button-reservations-filters-status" class="dopbsp-button"></a>
                                </div>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('reservations-filters-payment')" id="DOPBSP-inputs-button-reservations-filters-payment" class="dopbsp-button"></a>
                                </div>
...
?>
                                ...
                                <div class="dopbsp-inputs-header dopbsp-hide dopbsp-last">
                                    ...
                                    <a href="javascript:DOPBSP.toggleInputs('reservations-filters-search')" id="DOPBSP-inputs-button-reservations-filters-search" class="dopbsp-button"></a>
                                </div>
...
<?php
                ...
                $this->displaySelectInput(array('id' => 'order',
                                                ...
                                                'value' => isset($_COOKIE['DOPBSP_reservations_order']) && $_COOKIE['DOPBSP_reservations_order'] != '' ? $_COOKIE['DOPBSP_reservations_order']:'',
                ...
                $this->displaySelectInput(array('id' => 'order-by',
                                                ...
                                                'value' => isset($_COOKIE['DOPBSP_reservations_order_by']) && $_COOKIE['DOPBSP_reservations_order_by'] != '' ? $_COOKIE['DOPBSP_reservations_order_by']:'',
 ...
 */
            ...
            function displaySelectInput($args = array()){
                ...
                array_push($html, ' <div class="dopbsp-input-wrapper '.$container_class.'">');
                array_push($html, '     <label for="DOPBSP-reservations-'.$id.'">'.$label.'</label>');
                array_push($html, '     <select name="DOPBSP-reservations-'.$id.'" id="DOPBSP-reservations-'.$id.'" class="dopbsp-left '.$input_class.'" '.($id !== 'start-hour' && $id !== 'end-hour' ? 'onchange="DOPBSPReservationsList.get('.($id == 'page' ? 'false':'').')"':'').'>');
                ...
                if ($DOPBSP->classes->backend_settings_users->permission(wp_get_current_user()->ID, 'view-all-calendars')){
                    ...
                    if (get_user_meta(wp_get_current_user()->ID, 'DOPBSP_permissions_calendars', true) != ''){
                        ...
                        if (count($calendars_found) > 0){
                           $calendars_assigned = $wpdb->get_results('SELECT * FROM '.$DOPBSP->tables->calendars.' WHERE id IN ('.implode(', ', $calendars_found).') ORDER BY id DESC');   
                        }
                    }
                    else{
                        ...
                        foreach ($calendars as $calendar){
                            ...
                            if (isset($calendars_found)){
                                if (!in_array($calendar->id, $calendars_found)){
                                    array_push($html_calendars, '<option value="'.$calendar->id.'" '.($_COOKIE['DOPBSP_reservations_calendar'] == $calendar->id ? 'selected="selected"':'').'>ID: '.$calendar->id.' - '.$calendar->name.'</option>');
                                }
                            }
