...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndExtraGroup')){
        class DOPBSPViewsBackEndExtraGroup extends DOPBSPViewsBackEndExtraGroups{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndExtraGroup(){
            }
                        ...
                        <div class="dopbsp-input-wrapper dopbsp-last">
                            ...
                            <div class="dopbsp-items-wrapper">
                                <div class="dopbsp-buttons">
                                    <a href="javascript:DOPBSPExtraGroupItem.add(<?php echo $group->id; ?>, '<?php echo $language; ?>')" class="dopbsp-button dopbsp-small dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('EXTRAS_EXTRA_GROUP_ADD_ITEM_SUBMIT'); ?></span></a>
...
?>
                    <div class="dopbsp-preview-wrapper">
                        ...
                        <div class="dopbsp-buttons-wrapper">
                            <a href="javascript:DOPBSPExtraGroup.toggle(<?php echo $group->id; ?>)" class="dopbsp-button dopbsp-toggle"><span class="dopbsp-info"><?php echo $DOPBSP->text('EXTRAS_EXTRA_GROUP_SHOW_SETTINGS'); ?></span></a>
                            <a href="javascript:DOPBSP.confirmation('EXTRAS_EXTRA_DELETE_GROUP_CONFIRMATION', 'DOPBSPExtraGroup.delete(<?php echo $group->id; ?>)')" class="dopbsp-button dopbsp-delete"><span class="dopbsp-info"><?php echo $DOPBSP->text('EXTRAS_EXTRA_DELETE_GROUP_SUBMIT'); ?></span></a>
 ...
 */       
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-extra-group-'.$id.'-'.$extra_group_id.'" id="DOPBSP-extra-group-'.$id.'-'.$extra_group_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPExtraGroup.edit('.$extra_group_id.', \'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
