...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndDiscounts')){
        class DOPBSPViewsBackEndDiscounts extends DOPBSPViewsBackEnd{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndDiscounts(){
            }
...
?>                  
                                <a href="javascript:DOPBSPDiscount.add()" class="dopbsp-button dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('DISCOUNTS_ADD_DISCOUNT_SUBMIT'); ?></span></a>
