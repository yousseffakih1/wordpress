...
* Description             : Booking System PRO back end discount item views class.
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndDiscountItem')){
        class DOPBSPViewsBackEndDiscountItem extends DOPBSPViewsBackEndDiscountItems{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndDiscountItem(){
            }
            ...
            function template($args = array()){
                ...
                $rules = $wpdb->get_results('SELECT * FROM '.$DOPBSP->tables->discounts_items_rules.' WHERE discount_item_id='.$item->id.' ORDER BY position ASC');  
?>
                        ...
                        <div class="dopbsp-input-wrapper dopbsp-last">
                            ...
                            <div class="dopbsp-rules-wrapper">
                                <div class="dopbsp-buttons">
                                    <a href="javascript:DOPBSPDiscountItemRule.add(<?php echo $item->id; ?>, '<?php echo $language; ?>')" class="dopbsp-button dopbsp-small dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('DISCOUNTS_DISCOUNT_ITEM_ADD_RULE_SUBMIT'); ?></span></a>
...
?>
                    <div class="dopbsp-preview-wrapper">
                        ...
                        <div class="dopbsp-buttons-wrapper">
                            <a href="javascript:DOPBSPDiscountItem.toggle(<?php echo $item->id; ?>)" class="dopbsp-button dopbsp-toggle"><span class="dopbsp-info"><?php echo $DOPBSP->text('DISCOUNTS_DISCOUNT_ITEM_SHOW_SETTINGS'); ?></span></a>
                            <a href="javascript:DOPBSP.confirmation('DISCOUNTS_DISCOUNT_DELETE_ITEM_CONFIRMATION', 'DOPBSPDiscountItem.delete(<?php echo $item->id; ?>)')" class="dopbsp-button dopbsp-delete"><span class="dopbsp-info"><?php echo $DOPBSP->text('DISCOUNTS_DISCOUNT_DELETE_ITEM_SUBMIT'); ?></span></a>
 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'"  class="dopbsp-left '.$input_class.'" id="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPDiscountItem.edit('.$discount_item_id.', \'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPDiscountItem.edit('.$discount_item_id.', \'text\', \''.$id.'\', this.value)" onblur="DOPBSPDiscountItem.edit('.$discount_item_id.', \'text\', \''.$id.'\', this.value, true)" />');
            ...
            function displaySelectInput($args = array()){
                ...
                array_push($html, ' <div class="dopbsp-input-wrapper '.$container_class.'">');
                array_push($html, '     <label for="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'">'.$label.'</label>');
                array_push($html, '     <select type="text" name="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'" class="dopbsp-left '.$input_class.'" id="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'" value="'.$value.'" onchange="DOPBSPDiscountItem.edit('.$discount_item_id.', \'select\', \''.$id.'\', this.value);" >');
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'" id="DOPBSP-discount-item-'.$id.'-'.$discount_item_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPDiscountItem.edit('.$discount_item_id.', \'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
