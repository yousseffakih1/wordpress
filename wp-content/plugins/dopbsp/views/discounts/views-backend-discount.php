...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndDiscount')){
        class DOPBSPViewsBackEndDiscount extends DOPBSPViewsBackEndDiscounts{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndDiscount(){
            }
 ...
 */         
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-discount-'.$id.'-'.$discount_id.'" id="DOPBSP-discount-'.$id.'-'.$discount_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPDiscount.edit('.$discount_id.', \'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
