...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndDiscountItemRule')){
        class DOPBSPViewsBackEndDiscountItemRule extends DOPBSPViewsBackEndDiscountItem{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndDiscountItemRule(){
            }
...
?>
                <li id="DOPBSP-discount-item-rule-<?php echo $rule->id; ?>" class="dopbsp-item-rule-wrapper">
                    <div class="dopbsp-input-wrapper">
                        ...
                        <a href="javascript:DOPBSP.confirmation('DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_CONFIRMATION', 'DOPBSPDiscountItemRule.delete(<?php echo $rule->id; ?>)')" class="dopbsp-button dopbsp-small dopbsp-delete"><span class="dopbsp-info"><?php echo $DOPBSP->text('DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_SUBMIT'); ?></span></a>
                        ...
                        <!--
                            End date
                        -->
                        <input type="text" name="DOPBSP-discount-item-rule-end-date-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-end-date-<?php echo $rule->id; ?>" class="DOPBSP-discount-item-rule-end-date dopbsp-date" value="<?php echo $rule->end_date; ?>" style="margin-left:5px;" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'end_date', this.value);}" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'end_date', this.value)" onpaste="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'end_date', this.value)" onblur="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'end_date', this.value, true)" />                        
                        <br class="dopbsp-clear" />
                        
                        <!--
                            Start Hour
                        -->
                        <select name="DOPBSP-discount-item-rule-start-hour-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-start-hour-<?php echo $rule->id; ?>" class="dopbsp-no-margin dopbsp-hour" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'select', 'start_hour', this.value)">
                            <option value=""></option>
<?php
...
?>
                        ...
                        <!--
                            End Hour
                        -->
                        <select name="DOPBSP-discount-item-rule-end-hour-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-end-hour-<?php echo $rule->id; ?>" class="dopbsp-hour" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'select', 'end_hour', this.value)">
                            <option value=""></option>
<?php
                for ($i=0; $i<count($hours); $i++){
?>
...
?>
                        ...
                        <select name="DOPBSP-discount-item-rule-operation-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-operation-<?php echo $rule->id; ?>" class="dopbsp-small" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'select', 'operation', this.value)">
                        ...
                        <input type="text" name="DOPBSP-discount-item-rule-price-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-price-<?php echo $rule->id; ?>" class="dopbsp-small DOPBSP-input-discount-item-rule-price" value="<?php echo $rule->price; ?>" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'price', this.value);}" onpaste="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'price', this.value)" onblur="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'text', 'price', this.value, true)" />
                        ...
                        <select name="DOPBSP-discount-item-rule-price_type-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-price_type-<?php echo $rule->id; ?>" class="dopbsp-small" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'select', 'price_type', this.value)">
                        ...
                        <select name="DOPBSP-discount-item-rule-price_by-<?php echo $rule->id; ?>" id="DOPBSP-discount-item-rule-price_by-<?php echo $rule->id; ?>" class="dopbsp-small" onchange="DOPBSPDiscountItemRule.edit(<?php echo $rule->id; ?>, 'select', 'price_by', this.value)">
