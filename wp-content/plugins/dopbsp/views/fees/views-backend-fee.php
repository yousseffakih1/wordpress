...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndFee')){
        class DOPBSPViewsBackEndFee extends DOPBSPViewsBackEndFees{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndFee(){
            }
 ...
 */         
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-fee-'.$id.'-'.$fee_id.'" id="DOPBSP-fee-'.$id.'-'.$fee_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPFee.edit('.$fee_id.', \'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
