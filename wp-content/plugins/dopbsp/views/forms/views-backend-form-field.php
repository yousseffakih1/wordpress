...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndFormField')){
        class DOPBSPViewsBackEndFormField extends DOPBSPViewsBackEndFormFields{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndFormField(){
            }
                        ...
                        <div class="dopbsp-input-wrapper dopbsp-last">
                            ...
                            <div class="dopbsp-select-options-wrapper">
                                <div class="dopbsp-buttons">
                                    <a href="javascript:DOPBSPFormFieldSelectOption.add(<?php echo $field->id; ?>, '<?php echo $language; ?>')" class="dopbsp-button dopbsp-small dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('FORMS_FORM_FIELD_SELECT_ADD_OPTION_SUBMIT'); ?></span></a>
...
?>
                        ...
                        <div class="dopbsp-buttons-wrapper">
                            <a href="javascript:DOPBSPFormField.toggle(<?php echo $field->id; ?>)" class="dopbsp-button dopbsp-toggle"><span class="dopbsp-info"><?php echo $DOPBSP->text('FORMS_FORM_FIELD_SHOW_SETTINGS'); ?></span></a>
                            <a href="javascript:DOPBSP.confirmation('FORMS_FORM_DELETE_FIELD_CONFIRMATION', 'DOPBSPFormField.delete(<?php echo $field->id; ?>)')" class="dopbsp-button dopbsp-delete"><span class="dopbsp-info"><?php echo $DOPBSP->text('FORMS_FORM_DELETE_FIELD_SUBMIT'); ?></span></a>
 ...
 */         
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-form-field-'.$id.'-'.$form_field_id.'" id="DOPBSP-form-field-'.$id.'-'.$form_field_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPFormField.edit('.$form_field_id.', \'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');
