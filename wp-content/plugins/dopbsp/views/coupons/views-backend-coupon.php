...
*/
    ...
    if (!class_exists('DOPBSPViewsBackEndCoupon')){
        class DOPBSPViewsBackEndCoupon extends DOPBSPViewsBackEndCoupons{
             ...
             * Constructor
             */
            function DOPBSPViewsBackEndCoupon(){
            }
 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                if ($code_help != '') {
                    array_push($html, '     <a href="javascript:void(0)" onclick="DOPBSPCoupon.generateCode('.$coupon_id.');" target="_blank" class="dopbsp-button dopbsp-generate-code"><span class="dopbsp-info">'.$code_help.'</span></a>');
                }
