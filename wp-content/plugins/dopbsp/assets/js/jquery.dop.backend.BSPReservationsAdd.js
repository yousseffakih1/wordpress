...
* Description             : Booking System PRO backend end add reservations jQuery plugin.
*/
        ...
        methods_calendar = {
             ...
             */
                ...
                if (Container.width() <= 400){
                    $('.DOPBSPReservationsAdd-navigation .dopbsp-month-year', Container).html(methods_months.text['names'][(methods_calendar.vars.currMonth%12 !== 0 ? methods_calendar.vars.currMonth%12:12)-1]+' '+methods_calendar.vars.currYear); 
                }
                else{
                    $('.DOPBSPReservationsAdd-navigation .dopbsp-month-year', Container).html(methods_months.text['names'][(methods_calendar.vars.currMonth%12 !== 0 ? methods_calendar.vars.currMonth%12:12)-1]+' '+methods_calendar.vars.currYear); 
                }                        
            ...
            navigation: {
                 ...
                 */  
                    ...
                    if ($('.DOPBSPReservationsAdd-navigation', Container).width() <= 400){
                        $('.DOPBSPReservationsAdd-navigation .dopbsp-month-year', Container).html(methods_months.text['names'][(methods_calendar.vars.currMonth%12 !== 0 ? methods_calendar.vars.currMonth%12:12)-1]+' '+(new Date(methods_calendar.vars.startYear, methods_calendar.vars.currMonth, 0).getFullYear()))
...
// 8. Months
        ...
        methods_month = {
             ...
             */    
                ...
                if (position > 1){
                    HTML.push('<div class="DOPBSPReservationsAdd-month-year">'+methods_months.text['names'][(month%12 !== 0 ? month%12:12)-1]+' '+year+'</div>');
                }
        ...
        methods_days = {
             ...
             */
                ...
                if (methods_search.days.validate(ciDay) 
                    ...
                    if (noDays < minNoDays){
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['minTimeLapseDaysWarning'].replace(/%d/gi, minNoDays));
                    ...
                    if (maxNoDays !== 0
                            && noDays > maxNoDays){
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['maxTimeLapseDaysWarning'].replace(/%d/gi, maxNoDays));
                        methods_reservation.toggleMessages(methods_reservation.text['selectDays'], '');
                        methods_reservation.clear();
                        return false;
                    }
                    ...
                    if (schedule[selectedDays[0]] === undefined 
                        ...
                        DOPBSP.toggleMessages('error',
                                              methods_search.text['noServices']);
                        methods_reservation.toggleMessages(methods_reservation.text['selectDays'], '');
                        methods_reservation.clear();
                        return false;
                    }
                    ...
                    if (schedule[selectedDays[0]]['bind'] === 2 
                        ...
                        DOPBSP.toggleMessages('error',
                                              methods_search.text['noServicesSplitGroup']);
                        methods_reservation.toggleMessages(methods_reservation.text['selectDays'], '');
                        methods_reservation.clear();
                        return false;
                    }
                        ...
                        setTimeout(function(){
                            if (!$day.hasClass('dopbsp-mask') 
                                 ...
                                 */                                                       
                                    ...
                                    $('#DOPBSPReservationsAdd-check-out-view'+ID).val(methods_search.text['checkOut'])
                                                                                 .removeAttr('disabled');;
...
// 10. Hours
        ...
        methods_hours = {
             ...
             */
                ...
                $('#DOPBSPReservationsAdd-check-in-view'+ID).val(methods_calendar.data['dateType'] === 1 ? methods_months.text['names'][parseInt(month, 10)-1]+' '+day+', '+year:
             ...
             */
                ...
                if (methods_search.days.validate(day) 
                    ...
                    if (noMinutes < minNoMinutes){
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['minTimeLapseHoursWarning'].replace(/%d/gi, minNoMinutes/60));
                    ...
                    if (maxNoMinutes !== 0
                        ...
                        DOPBSP.toggleMessages('error',
                                              methods_rules.text['maxTimeLapseHoursWarning'].replace(/%d/gi, maxNoMinutes/60));
                        methods_reservation.toggleMessages(methods_reservation.text['selectHours'], '');
                        methods_reservation.clear();
                        return false;
                    }
...
// 12. Search
        ...
        methods_search = {
             ...
             */    
                ...
                HTML.push(' <h3>'+methods_search.text['title']+'</h3>');
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-search'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-search'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-search'+ID+'" class="dopbsp-inputs-wrapper">');
            ...
            days: {
                 ...
                 */
                    ...
                    HTML.push('     <label for="DOPBSPReservationsAdd-check-in-view'+ID+'">'+methods_search.text['checkIn']+'</label>');
                    ...
                    if (!methods_hours.data['enabled'] 
                        ...
                        HTML.push(' <div class="dopbsp-input-wrapper">');
                        HTML.push('     <label for="DOPBSPReservationsAdd-check-out-view'+ID+'">'+methods_search.text['checkOut']+'</label>');
            ...
            hours: {
                 ...
                 */
                     ...
                     */
                    HTML.push(' <div class="dopbsp-input-wrapper">');
                    HTML.push('     <label for="DOPBSPReservationsAdd-start-hour'+ID+'">'+methods_search.text['hourStart']+'</label>');
                    ...
                    if (methods_hours.data['multipleSelect']){
                        HTML.push(' <div class="dopbsp-input-wrapper">');
                        HTML.push('     <label for="DOPBSPReservationsAdd-end-hour'+ID+'">'+methods_search.text['hourEnd']+'</label>');
                 ...
                 */
                    var HTML = new Array();
                     ...
                     if (methods_sidebar.data['noItems']){
                        ...
                        HTML.push('     <label for="DOPBSPReservationsAdd-no-items'+ID+'">'+methods_search.text['noItems']+'</label>');
             ...
             */    
                return methods_rules.data['id'] !== '0' 
                            && (!methods_hours.data['enabled'] && methods_days.data['multipleSelect']
                                            || methods_hours.data['enabled'] && methods_hours.data['multipleSelect']) ? parseInt(methods_rules.data['rule']['time_lapse_min'], 10):0;
            }
        },
...
// 14. Extras
        ...
        methods_extras = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-extras'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-extras'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
...
// 17. Coupons
        ...
        methods_coupons = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-coupons'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-coupons'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
                ...
                HTML.push('     <label for="DOPBSPReservationsAdd-coupons-code'+ID+'">'+methods_coupons.text['code']+'</label>');
                ...
                HTML.push('     <input type="button" name="DOPBSPReservationsAdd-coupons-verify'+ID+'" id="DOPBSPReservationsAdd-coupons-verify'+ID+'" class="DOPBSPReservationsAdd-hidden" value="'+methods_coupons.text['verify']+'" />');
                HTML.push('     <input type="button" name="DOPBSPReservationsAdd-coupons-use'+ID+'" id="DOPBSPReservationsAdd-coupons-use'+ID+'" class="DOPBSPReservationsAdd-hidden" value="'+methods_coupons.text['use']+'" />');
             ...
             */  
                ...
                $.post(ajaxurl, {action: 'dopbsp_coupons_verify',
                    ...
                    if (data === 'success'){
                        ...
                        DOPBSP.toggleMessages('success', methods_coupons.text['verifySuccess']);
                                                       
                    }
                    else{
                        DOPBSP.toggleMessages('error', methods_coupons.text['verifyError']);
                    }
                });
            },
...
// 19. Reservation
        ...
        methods_reservation = {
             ...
             */
                ...
                HTML.push('<div class="dopbsp-inputs-header dopbsp-hide">');
                HTML.push(' <h3>'+methods_reservation.text['title']+'</h3>');
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-reservation'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-reservation'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
...
// 21. Form
        ...
        methods_form = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-form'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-form'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
                ...
                for (i=0; i<form.length; i++){
                    ...
                    switch (formField['type']){
                        case 'checkbox':
                            ...
                            HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-form-field-warning'+ID+'_'+formField['id']+'" class="dopbsp-button dopbsp-warning-info dopbsp-checkbox-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+formField['translation']+' '+methods_form.text['required']+'</span></a>');
                            break;
                        case 'select':
                            /*
                             * Select field.
                            ...
                            HTML.push('     </select>');
                            HTML.push('     <a href="javascript:void(0)" id="DOPBSPReservationsAdd-form-field-warning'+ID+'_'+formField['id']+'" class="dopbsp-button dopbsp-warning-info"><span class="dopbsp-info dopbsp-warning-info">'+formField['translation']+' '+methods_form.text['required']+'</span></a>');
                            break;
                        case 'text':
                            /*
                             * Text field.
...
// 22. Order
        ...
        methods_order = {
             ...
             */
                ...
                HTML.push('<div class="dopbsp-inputs-header dopbsp-hide">');
                HTML.push(' <h3>'+methods_order.text['title']+'</h3>');
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPReservationsAdd-order'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPReservationsAdd-order'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
                HTML.push('<div id="DOPBSP-inputs-DOPBSPReservationsAdd-order'+ID+'" class="dopbsp-inputs-wrapper dopbsp-last">');
                HTML.push(' <div class="dopbsp-input-wrapper">');
                HTML.push('     <label for="DOPBSPReservationsAdd-status'+ID+'">'+methods_reservation.text['status']+'</label>');
                HTML.push('     <select name="DOPBSPReservationsAdd-status'+ID+'" id="DOPBSPReservationsAdd-status'+ID+'">');
                HTML.push('         <option value="approved">'+methods_reservation.text['statusApproved']+'</option>');
                HTML.push('         <option value="pending">'+methods_reservation.text['statusPending']+'</option>');
                HTML.push('     </select>');
                HTML.push(' </div>');
                 ...
                 */
                HTML.push(' <div class="dopbsp-input-wrapper">');
                HTML.push('     <label class="dopbsp-for-radios">'+methods_order.text['paymentMethod']+'</label>');
                ...
                HTML.push('         <label class="dopbsp-for-radio">'+methods_order.text['paymentMethodNone']+'</label>');
                ...
                HTML.push('         <label class="dopbsp-for-radio">'+methods_order.text['paymentMethodArrival']+'</label>');
                HTML.push('         <br class="DOPBSPReservationsAdd-clear" />');
                ...
                for (key in paymentGateways){
                    ...
                    HTML.push('     <label class="dopbsp-for-radio">'+paymentGateways[key]['title']+'</label>');
                    HTML.push('     <br class="DOPBSPReservationsAdd-clear" />');
                }
                HTML.push('     </div>');
                HTML.push(' </div>');
                 ...
                 */
                HTML.push(' <div class="dopbsp-input-wrapper dopbsp-last">');
                HTML.push('     <label for="DOPBSPReservationsAdd-transaction-id'+ID+'">'+methods_order.text['paymentMethodTransactionID']+'</label>');
                ...
                HTML.push('     <label>&nbsp;</label>');
                HTML.push('     <input type="submit" name="DOPBSPReservationsAdd-submit'+ID+'" id="DOPBSPReservationsAdd-submit'+ID+'" value="'+methods_order.text['book']+'" />');
                HTML.push(' </div>');
                HTML.push('</div>');
             ...
             * Book a reservation.
             */    
                var paymentMethod = $('input[name=DOPBSPReservationsAdd-payment'+ID+']:checked').val() === undefined ? 'none':$('input[name=DOPBSPReservationsAdd-payment'+ID+']:checked').val();
                ...
                DOPBSP.toggleMessages('active',
                                      DOPBSP.text('MESSAGES_SAVING'));
                ...
                $.post(ajaxurl, {action: 'dopbsp_reservations_add_book',
                    ...
                    if (data === 'unavailable'){
                        DOPBSP.toggleMessages('error',
                                              methods_order.text['unavailable']);
                        methods_reservation.clear();
                    ...
                    if (data === 'unavailable-coupon'){
                        DOPBSP.toggleMessages('error',
                                              methods_order.text['unavailableCoupon']);
                        methods_coupons.vars.use = false;
                        methods_reservation.set();
