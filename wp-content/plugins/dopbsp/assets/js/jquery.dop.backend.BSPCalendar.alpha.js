...
* File Version            : 1.0
* Created / Last Modified : 19 September 2014
* Author                  : Dot on Paper
* Copyright               : © 2012 Dot on Paper
* Website                 : http://www.dotonpaper.net
* Description             : Booking System PRO backend end calendar jQuery plugin.
*/
...
//                methods_filters.set();
            ...
            days: {
                display:function(){
                    ...
                    HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPCalendar-filters-days'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPCalendar-filters-days'+ID+'" class="dopbsp-button"></a>');
                 ...
                 */    
                    ...
                    HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPCalendar-filters-days'+ID+'-'+year+'-'+month+'\')" id="DOPBSP-inputs-button-DOPBSPCalendar-filters-days'+ID+'-'+year+'-'+month+'" class="dopbsp-button"></a>');
            ...
            hours: {
                display:function(){
                    ...
                    HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPCalendar-filters-hours'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPCalendar-filters-hours'+ID+'" class="dopbsp-button"></a>');
                    HTML.push('</div>');
...
// 14. Form
        ...
        methods_form = {
             ...
             */
                ...
                HTML.push(' <a href="javascript:DOPBSP.toggleInputs(\'DOPBSPCalendar-form'+ID+'\')" id="DOPBSP-inputs-button-DOPBSPCalendar-form'+ID+'" class="dopbsp-button"></a>');
                HTML.push('</div>');
