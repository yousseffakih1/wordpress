...
* Description             : Booking System PRO backend end reservations calendar jQuery plugin.
*/
...
// 10. Reservations
        ...
        methods_reservations = {
             ...
             */    
                 ...
                 * Save status filters.
                 */
                DOPBSPReservations.saveFilters({status_pending: displayPending,
                 ...
                 */
                DOPBSPReservations.saveFilters({payment_methods: displayPayment.join(',')});
        ...
        methods_reservation = {
             ...
             */
                var i,
                reservations_data = methods_reservations.vars.reservationsData;
                ...
                switch (action){
                    ...
                    case 'cancel':
                        ...
                        break;
                    case 'delete':
                        for (i=0; i<reservations_data.length; i++){
                            if (reservations_data[i]['id'] === id){
                                methods_reservations.vars.reservationsData.splice(i, 1);
            ...
            events: {
                 ...
                 */    
                    ...
                    $('#DOPBSPReservationsCalendar-tooltip'+ID+' .dopbsp-button-cancel').bind('click', function(){
                        methods_reservation.events.confirmation('RESERVATIONS_RESERVATION_CANCEL_CONFIRMATION',
                                                                $(this).attr('id').split('DOPBSPReservationsCalendar-reservation-cancel')[1],
                                                                'cancel');
                    });
        ...
        methods_order = {
             ...
             */
                ...
                switch (reservation['payment_method']){
                    ...
                    default:
                        HTML.push(methods_reservation.displayData(methods_order.text['paymentMethod'],
                                                                  paymentGateways[reservation['payment_method']]['title']));
