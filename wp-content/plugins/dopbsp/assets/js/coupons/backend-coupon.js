...
var DOPBSPCoupon = new function(){
    ...
    this.display = function(id,
        ...
        $.post(ajaxurl, {action: 'dopbsp_coupon_display', 
            ...
            HTML.push('<a href="javascript:DOPBSP.confirmation(\'COUPONS_DELETE_COUPON_CONFIRMATION\', \'DOPBSPCoupon.delete('+id+')\')" class="dopbsp-button dopbsp-delete"><span class="dopbsp-info">'+DOPBSP.text('COUPONS_DELETE_COUPON_SUBMIT')+'</span></a>');
    ...
    this.delete = function(id){
        ...
        $.post(ajaxurl, {action: 'dopbsp_coupon_delete', 
            ...
            $('#DOPBSP-coupon-ID-'+id).stop(true, true)
                ...
                if (data === '0'){
                    $('#DOPBSP-column1 .dopbsp-column-content').html('<ul><li class="dopbsp-no-data">'+DOPBSP.text('COUPONS_NO_COUPONS')+'</li></ul>');
                }
