...
var DOPBSPRule = new function(){
    ...
    this.display = function(id,
        ...
        $.post(ajaxurl, {action: 'dopbsp_rule_display', 
            ...
            HTML.push('<a href="javascript:DOPBSP.confirmation(\'RULES_DELETE_RULE_CONFIRMATION\', \'DOPBSPRule.delete('+id+')\')" class="dopbsp-button dopbsp-delete"><span class="dopbsp-info">'+DOPBSP.text('RULES_DELETE_RULE_SUBMIT')+'</span></a>');
    ...
    this.delete = function(id){
        ...
        $.post(ajaxurl, {action: 'dopbsp_rule_delete', 
            ...
            $('#DOPBSP-rule-ID-'+id).stop(true, true)
                ...
                if (data === '0'){
                    $('#DOPBSP-column1 .dopbsp-column-content').html('<ul><li class="dopbsp-no-data">'+DOPBSP.text('RULES_NO_RULES')+'</li></ul>');
                }
